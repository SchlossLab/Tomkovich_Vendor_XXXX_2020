...
plot_grid(left_panel, d, labels = c("", "D"), label_size = 12, ncol=2)+
  ggsave("results/figures/figure_4.pdf", width=6.875, height=5.16)+
  ggsave("submission/figure_4.tiff", width=6.875, height=5.16, dpi = 300, device = "tiff", compression = "lzw", units = "in")
