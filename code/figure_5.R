...
f <- ggdraw() + draw_image("results/figures/Dn1toD1_families_d1.png")


plot_grid(a, b, c, d, e, f, labels = "AUTO", label_size = 12, ncol=3)+
  ggsave("results/figures/figure_5.pdf", width=8, height=6)+
  ggsave("submission/figure_5.pdf", width=8, height=6)
